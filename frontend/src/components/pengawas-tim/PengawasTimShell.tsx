...
import { FileCheck2, FileSignature, LayoutGrid, ShieldCheck } from 'lucide-react'
...
export const PENGAWAS_TIM_NAV_ITEMS: SidebarNavItem[] = [
  ...
  { label: 'Persetujuan Penugasan (PPP)', icon: FileSignature, path: '/pengawas-tim/persetujuan-ppp' },
